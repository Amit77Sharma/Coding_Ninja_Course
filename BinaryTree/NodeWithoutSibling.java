...
public class NodeWithoutSibling {
	...
	public static BinaryTreeNode<Integer> TakeInput(boolean isRoot,int parent, boolean isLeft){
		if(isRoot) {
			...
			System.out.println("Enter the rightchild od the node");
		}
	...
	public static void NodeWithoutChild(BinaryTreeNode<Integer> root) {
		if(root==null) {
			return;
		}
		...
		NodeWithoutChild(root.left);
		NodeWithoutChild(root.right);
	}
